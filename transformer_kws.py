# -*- coding: utf-8 -*-
"""transformer_kws.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vI7m0osFtpWXcYCCXwLZYEgP2Qc7jRRf
"""
...
class KWSDataModule(LightningDataModule):
    def __init__(self, path, batch_size=128, num_workers=48, n_fft=512, 
...
if __name__ == "__main__":
    ...
    datamodule = KWSDataModule(batch_size=args.batch_size, num_workers=args.num_workers,
                               ...
                               class_dict=CLASS_TO_IDX, patch_num=args.patch_num)
    datamodule.setup()
